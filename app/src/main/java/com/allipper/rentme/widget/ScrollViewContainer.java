...
public class ScrollViewContainer extends RelativeLayout {
     ...
     * 设置改变textview值的接口
     */
    private onScrollViewChangeListener listener;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mLastY = ev.getY();
                requestLayout();
                listener.changeTextValue(mCurrentViewIndex);
                break;
    ...
    public void setListener(onScrollViewChangeListener listener) {
        this.listener = listener;
    }

    public interface onScrollViewChangeListener {
        /**
         * 根据scrollViewContainer的状态来改变TextView的显示
         *
         * @param index
         */
        void changeTextValue(int index);

        /**
         * 如果是显示为第一个ScrollView,那么TextView姐显示为上拉显示
         */
        void setTextValue();
