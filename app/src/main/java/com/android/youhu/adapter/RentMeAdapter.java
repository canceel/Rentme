...
public class RentMeAdapter extends CommonAdapter<RentMeResponse.DataEntity.ItemsEntity> {

    public RentMeAdapter(Context context, List<RentMeResponse.DataEntity.ItemsEntity> datas) {
        super(context, datas);
